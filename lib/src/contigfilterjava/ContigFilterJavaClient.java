 ...
 * </pre>
 */
public class ContigFilterJavaClient {
     ...
     */
    public ContigFilterJavaClient(URL url) {
     ...
     * validity.
     */
    public ContigFilterJavaClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ContigFilterJavaClient(URL url, String user, String password) throws UnauthorizedException, IOException {
    ...
    public FilterContigsResults filterContigs(FilterContigsParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<FilterContigsResults> res = caller.jsonrpcCall("ContigFilterJava.filter_contigs", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }
}
