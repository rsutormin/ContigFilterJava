...
import contigfilterjava.FilterContigsParams;
import contigfilterjava.FilterContigsResults;
import contigfilterjava.ContigFilterJavaServer;
...
public class ContigFilterJavaServerTest {
    private static AuthToken token = null;
    private static Map<String, String> config = null;
    private static WorkspaceClient wsClient = null;
    private static String wsName = null;
    private static ContigFilterJavaServer impl = null;
    ...
    public static void init() throws Exception {
        ...
        config = ini.get("ContigFilterJava");
        ...
        impl = new ContigFilterJavaServer();
    }
    
    private static String getWsName() throws Exception {
        if (wsName == null) {
            long suffix = System.currentTimeMillis();
            wsName = "test_ContigFilterJava_" + suffix;
    ...
    private static RpcContext getContext() {
        return new RpcContext().withProvenance(Arrays.asList(new ProvenanceAction()
            .withService("ContigFilterJava").withMethod("please_never_use_it_in_production")
